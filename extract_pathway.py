...
class PathWayProcessor:
    ...
    # output:
    def get_all_top_level_pathways(self) -> list[str]:
...
class PhysicalEntityProcessor:
    ...
    def get_unique_components_without_duplicate_names_and_mapping_components_names_list_and_physical_entity_id_to_list_of_component_ids_dict_from_list_of_physical_entities(
        ...
        component_name_to_component_id_dict_on_to_one = dict()
        ...
        for component_id in original_component_ids_unique:
            ...
            component_name_to_component_id_dict_on_to_one[component_name] = component_id
        ...
        for component_name in components_names_list:
            component_id = component_name_to_component_id_dict_on_to_one[component_name]
...
class ReactomeProcessor:
        ...
        for relationship in relationships:
            ...
            # == 0
                ...
                if reaction_index in reaction_index_to_list_of_regulation_relationship_dic.keys():
                    list_of_regulation_relationships = reaction_index_to_list_of_regulation_relationship_dic[reaction_index]
    ...
    def execution_on_single_pathways(self, pathway_stId):
        ...
        reaction_to_regulation_relationship_status_dic = self.get_reaction_status_dic(reaction_index_to_list_of_regulation_relationship_dic)
    ...
    def execution_on_single_pathways_enhanced(self, pathway_stId):
        ...
        # store data into a txt file
        file_processor = FileProcessor()
        file_processor.execute_for_single_pathway_with_name(pathway_name, reaction_ids, reaction_names,
    ...
    def execution_on_reactome_enhanced(self):
        ...
        # store data into a txt file
        file_processor = FileProcessor()
        file_processor.execute_for_single_pathway_with_name("All_data_in_Reactome", reaction_ids, reaction_names,
                                                            physical_entity_ids, physical_entity_names,
                                                            relationships_between_nodes_edges, component_ids,
                                                            component_names,
                                                            entity_component_mapping_list)
...
class FileProcessor:
    ...
    def execute_for_single_pathway_with_name(self, pathway_name, reaction_ids, reaction_names, physical_entity_ids,
...
if __name__ == '__main__':
    ...
    # R-HSA-389550
    # R-HSA-389540
    # reactome_processor.test_reaction_id_and_names_based_on_pathway_stId("R-HSA-1430728")
    ...
    # reactome_processor.execution_on_single_pathways_enhanced("R-HSA-5653656")


    # R-HSA-8953897
    # reactome_processor.execution_on_single_pathways_enhanced("R-HSA-8953897")
    ...
    reactome_processor.execution_on_reactome_enhanced()

    # reactome_processor.execution_on_all_pathways()

    # reactome_processor.execution_on_all_pathways_enhanced()
