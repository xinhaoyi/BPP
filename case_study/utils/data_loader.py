...
from case_study.utils.utils import read_file_via_lines, encode_node_features, encode_edges_features
...
class Database:
    ...
    def __init__(self, name, task, data_version_name: str = ''):
        self.dataset = name
        self.task = task
        self.data_version_name = data_version_name
        self.load_dataset()
    ...
    def load_other_to_graph(self, name, task, subset):
        data_path = os.path.join("../multi_version_datasets/static/data", name)
        relation_path = os.path.join(data_path, task, subset, "relationship.txt")
        mat = pd.read_csv(
            relation_path, names=["entity", "reaction", "type"], header=None
        )
...
class DataLoaderBase:
    def __init__(self, sub_dataset_name, task_name, data_version_name: str = ''):
        ...
        self.raw_data_file_path = os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(__file__))),
                                               'multi_version_datasets', self.data_version_name, sub_dataset_name)
...
class DataLoaderAttribute(DataLoaderBase):
    def __init__(self, sub_dataset_name, task_name, data_version_name: str = ''):
        super().__init__(sub_dataset_name, task_name, data_version_name)
...
class DataLoaderLink(DataLoaderBase):
    def __init__(self, sub_dataset_name, task_name, data_version_name: str = ''):
        ...
        self.edge_to_list_of_all_masked_nodes_dict: dict[int, list[int]] = self.__get_edge_to_all_masked_nodes_dict()
        self.edge_to_list_of_masked_nodes_for_test_dict: dict[
            int, list[int]] = self.__get_edge_to_masked_nodes_for_test_dict()
        self.edge_to_list_of_masked_nodes_for_validation_dict: dict[
            int, list[int]] = self.__get_edge_to_masked_nodes_for_validation_dict()
        ...
        self.__function_dict = {
            ...
            "edge_to_list_of_all_masked_nodes_dict": self.edge_to_list_of_all_masked_nodes_dict,
            "edge_to_list_of_masked_nodes_for_test_dict": self.edge_to_list_of_masked_nodes_for_test_dict,
            "edge_to_list_of_masked_nodes_for_validation_dict": self.edge_to_list_of_masked_nodes_for_validation_dict
        }
    ...
    def __get_edge_to_all_masked_nodes_dict(self):

        (
            edge_to_list_of_nodes_dict,
            _,
            _,
        ) = super().get_edge_to_list_of_masked_nodes_dict("train")
        return edge_to_list_of_nodes_dict

    def __get_edge_to_masked_nodes_for_test_dict(self):

        (
            edge_to_list_of_nodes_dict,
            _,
            _,
        ) = super().get_edge_to_list_of_masked_nodes_dict("test")
        return edge_to_list_of_nodes_dict

    def __get_edge_to_masked_nodes_for_validation_dict(self):

        (
            edge_to_list_of_nodes_dict,
            _,
            _,
        ) = super().get_edge_to_list_of_masked_nodes_dict("validation")
        return edge_to_list_of_nodes_dict
