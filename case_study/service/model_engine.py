...
from case_study.utils.data_loader import DataLoaderLink
from case_study.utils.utils import read_file_via_lines, encode_edges_features
...
class ModelEngine:
    ...
    def get_reactions_with_entities_masked_for_testing(self, data_version: DataVersion, threshold_degree: int) -> Tuple[list[Edge], list[Edge]]:
