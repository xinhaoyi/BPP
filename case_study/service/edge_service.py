...
class EdgeService:
    ...
    def get_edge_list_from_dataset(self, toplevel_pathway_name: str, data_version: DataVersion) -> list[Edge]:
    ...
    def get_edge_from_dataset_based_on_name(self, toplevel_pathway_name: str, content: str,
                                            data_version: DataVersion) -> list[Edge]:
        dataset: Dataset = data_version.dataset_dict[toplevel_pathway_name]
